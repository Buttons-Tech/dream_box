...
const program_data = [
  ...
  return (
   <>
    <div className='w-[393px] md:w-screen h-[237px] m-auto px-[25px] text-center py-[17px]  bg-[#FFDBF4]'>
        <span className='text-[36px] font-bold'>Is  <span className='text-[#A40C76]'>Your Child</span> Ready for the Future?</span><br />
        <span className='text-[16px] md:text-[26px] '> At Dreambox, we transform screen time into smart time, turning curiosity into valuable skills. We make learning code, robotics, and design an exciting adventure.</span>
    </div>
